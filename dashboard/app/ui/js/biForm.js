...
(function ($) {
    ...
    var inputManager = {
        ...
        // <label class="bi-form-nested-inverted"><input value="" name="" type="checkbox" checked="checked">[LABEL]</label>
        build: function (setting) {
            return $('<label>').addClass('bi-form-nested-inverted').text(setting.label).prepend(
                $('<input />').attr({
                    value: setting.value,
                    name: setting.name,
    ...
    // Warning: This script (biForm.js) should only be loaded once!
    ...
    $.biForm = {
        ...
        // Addon: Handle focus/blur events when a <select> is wrapped inside a CSS class .bi-form-select
        //      <div class="bi-form-select">
        //          <select><select/>
        //      </div>
        selectWrapperEventHandler: function (e) {
            var $parent = $(e.target.parentNode);
            if (!$parent.hasClass('bi-form-select')) return;
            $parent['focus' == e.type ? 'addClass' : 'removeClass']('bi-form-select-focus');
        }
    ...
    $(document).ready(function () {
        ...
        document.body.addEventListener('focus', $.biForm.selectWrapperEventHandler, true);
        document.body.addEventListener('blur', $.biForm.selectWrapperEventHandler, true);
    });
